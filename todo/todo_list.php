...
if(isset($_SESSION['edit_errorMessage'])==true){
$_SESSION['edit_errorMessage']='';
}
if(isset($_SESSION['registration_errorMessage'])==true){
$_SESSION['registration_errorMessage']='';
}
?>
        ...
        <table class="list">
            ...
            $dsn='mysql:dbname=todo;host=localhost;charset=utf8';
                    ...
                    $sql='SELECT 
                            ...
                            todo_items.id AS todo_items_id,item_name,
